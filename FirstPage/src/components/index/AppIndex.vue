...
<!-- <<<<<<< Updated upstream
  ...
  <el-container style="width: 100%; height: 100%; position: absolute">
    ...
    <el-container  style="height: 40%">
      ...
      <el-main style="width: 40%;">
        <vue-seamless-scroll :data="cityProjects" class="seamless-warp" :class-option="optionHover">
          <ul class="item">
            <li v-for="item in cityProjects" v-bind:key="item">
              <span class="title" v-text="item.item"></span>
